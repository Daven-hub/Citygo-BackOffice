...
export function StatsCard({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-[6px] border border-border bg-white px-6 py-3 transition-all duration-300 hover:border-primary/30 hover:shadow-lg group animate-slide-up",
        className
      )}
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="space-y-3">
          <h3 className="text-2xl font-bold text-black/70 text-foreground tracking-tight">{value}</h3>
          {displayChange && (
            <p
              className={cn(
                "text-xs font-medium",
